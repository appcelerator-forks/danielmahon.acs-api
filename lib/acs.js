...
function defineCloud(Cloud) {
    ...
    function requireArgument(name, arg, type) {
        ...
        if (typeof(arg) != type)
            throw new Error('Argument ' + name + ' is an unexpected type! Expected: ' + type + ', Received: ' + typeof(arg));
    }
...
*/
    ...
    var ACS = (function defineNativeACS() {
        ...
        function ACSSession(key, secret, baseURL) {
            return acs.createCocoafish(key, secret, baseURL);
        }
...
*/
        ...
        function fetchSession() {
            ...
            */
            ...
            throw new Error('ACS CREDENTIALS NOT SPECIFIED!');
        }
...
exports.init = function(key, secret, url) {
	apiKey = key;
	consumerKey = key;
